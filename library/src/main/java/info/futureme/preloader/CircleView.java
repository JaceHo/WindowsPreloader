...
public class CircleView extends View{
    ...
    public void layout(int l, int t, int r, int b){
        l += paddingLeft;
        t += paddingTop;
        super.layout(l , t, l + 2 * radis, t + radis * 2);
    }

    public void onDraw(Canvas canvas){
        canvas.drawCircle((float)(getLeft() - paddingLeft + radis), (float)(getTop() - paddingTop + radis), radis, paint);
    }
}
